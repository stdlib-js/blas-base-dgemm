...
```javascript
import dgemm from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dgemm@esm/index.mjs';
```
The previous example will load the latest bundled code from the esm branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-base-dgemm/tags). For example,

```javascript
import dgemm from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-dgemm@v0.1.1-esm/index.mjs';
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-base-dgemm.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-base-dgemm

[test-image]: https://github.com/stdlib-js/blas-base-dgemm/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-base-dgemm/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-base-dgemm/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-base-dgemm?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-base-dgemm.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-base-dgemm/main
...
[deno-url]: https://github.com/stdlib-js/blas-base-dgemm/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-base-dgemm/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-base-dgemm/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-base-dgemm/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-base-dgemm/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-base-dgemm/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-base-dgemm/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-base-dgemm/main/LICENSE
